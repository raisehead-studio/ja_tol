...
const ToBillInvoice = db_1.sequelize.define("tobill_invoce", {
    ...
    numbers_invoices: sequelize_1.default.INTEGER,
    numbers_reports: sequelize_1.default.INTEGER,
    numbers_general_forms: sequelize_1.default.INTEGER,
    numbers_inqualify_agreements: sequelize_1.default.INTEGER,
    numbers_envelope: sequelize_1.default.INTEGER,
